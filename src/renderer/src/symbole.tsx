...
export const LUCIDE_SYMBOLE: Record<string, { Icon: LucideIcon; suche: string }> = {
  ...
  upload: { Icon: Upload, suche: 'Hochladen Upload Veröffentlichen Posten' },
  code: { Icon: Code, suche: 'Code Programmieren App Entwicklung Software' },
  calculator: { Icon: Calculator, suche: 'Rechner Buchhaltung Rechnung Finanzen' },
  eye: { Icon: Eye, suche: 'Auge Ansehen Angucken Sichten Review' },
  gamepad: { Icon: Gamepad2, suche: 'Spiel Gaming Bowling Freizeit' },
  handshake: { Icon: Handshake, suche: 'Handschlag Kundentermin Besuch Abschluss' },
  user: { Icon: User, suche: 'Person Kontakt Ansprechpartner' },
  leaf: { Icon: Leaf, suche: 'Blatt Natur Lavendel Pflanze' },
  flower: { Icon: Flower2, suche: 'Blume Blüte Garten Florist' },
  wine: { Icon: Wine, suche: 'Wein Glas Weinbank Gastronomie' },
  droplets: { Icon: Droplets, suche: 'Tropfen Wasser Quelle Getränk' },
  house: { Icon: House, suche: 'Haus Zuhause Immobilie' },
  trophy: { Icon: Trophy, suche: 'Pokal Erfolg Gewinn' },
  sparkles: { Icon: Sparkles, suche: 'Funkeln Kreativ Neu' },
  sun: { Icon: Sun, suche: 'Sonne Solar Photovoltaik Energie' },
  bike: { Icon: Bike, suche: 'Fahrrad Rad Bike Radsport' }
}
