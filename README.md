...
### Fragen zur App (KI-Assistent, seit 1.0.49)

Oben rechts steht **Fragen**. Ein Klick öffnet einen Chat mit einem Claude-Modell, das diese ganze Anleitung kennt und deinen aktuellen Stand sieht (laufender Fokus, Stunden heute und diese Woche, Rang, Einstellungen, ob der Abgleich läuft). Es sieht keine einzelnen Blöcke und keine Fenstertitel. Frag es alles rund um die App: "Wie trage ich einen vergessenen Termin nach?", "Warum zählt meine Zeit gerade nicht?", "Was bedeutet Rang 7?". Antworten kommen nach ein paar Sekunden.
