...
- Im Fokus zählt jede Minute, in der du am Rechner arbeitest (seit 1.0.50). Ein kurzer Blick in wessamedia Zeit (bis 2 Minuten) läuft beim vorherigen Programm einfach mit, bleibst du länger, entsteht ab dem Wechsel ein eigener Block "wessamedia Zeit" mit deiner Fokus-Tätigkeit. Erkennt die App gerade kein Fenster (Schreibtisch, Startmenü, Fensterwechsel), läuft der Block weiter oder es entsteht ein Block "Ohne Fenster". Nur ohne Fokus (Regel-Betrieb, Schalter "Nur im Fokus aufzeichnen" aus) gilt weiter: die eigene App bekommt keinen Block.
...
Seit 1.0.51 prüft die App alle 30 Minuten und bei jedem Öffnen des Fensters auf eine neue Version. Sobald eine geladen ist, geht mitten in der App ein Fenster auf: "Version X ist da" mit der Liste der Neuerungen und dem Knopf "Jetzt aktualisieren und neu starten" (auf dem Mac ohne Selbst-Einspielen "Download öffnen"). "Später" schließt es, die kleine Leiste über der Navigation bleibt. Nach dem Neustart erscheint einmal "Neu in Version X".
...
- **Daily Quests** (Heute): Jeden Tag drei Aufgaben, für jede Person anders gewürfelt, zum Beispiel "Früher Vogel" (vor 9 Uhr die erste produktive Minute), "Am Stück" (2 Stunden ohne Unterbrechung), "Tagesziel" (7 Stunden), "Zwei Kunden", "Tiefenfokus" (90 Minuten in einer Tätigkeit), "Nachmittagsschub" (2 Stunden nach 14 Uhr) oder "Nachgetragen". Die Quest "Feierabend" (gilt am Tagesende) wird erst am nächsten Tag gutgeschrieben. Quests, die Zeit ohne Rechner bestrafen würden ("Kein Rot", "Sauberer Tag"), gibt es bewusst nicht: nicht am Rechner ist immer rot, und niemand arbeitet den ganzen Tag durch. Alle drei geschafft: 15 Punkte extra. Dazu der **Streak**: Tage in Folge mit mindestens 4 produktiven Stunden, jeder Tag 10 Punkte, Bonus bei 3, 7, 14 und 30 Tagen.
- **Duelle** (Team-Screen): "Herausfordern" öffnet ein Fenster: Gegner; Art ("Mehr Stunden" bis zu einem Zeitpunkt, "Wettlauf": wer zuerst z. B. 10 Stunden hat, gewinnt sofort, oder "Früher am Start" an einem wählbaren Tag); wahlweise nur eine Tätigkeit und/oder ein Kunde; Ende als Vorschlag (heute 20 Uhr, morgen 20 Uhr, Freitag 20 Uhr, Sonntag 24 Uhr) oder "Genau …" mit Datum und Uhrzeit; Einsatz (Standard "einen Kaffee") und eine freie Beschreibung. Der andere nimmt an oder lehnt ab; bei der Annahme erscheint bei beiden eine große Einblendung mit gekreuzten Schwertern und einer Fanfare (Schwerthiebe, Trommelwirbel, Dreiklang). Laufende Duelle zeigen den Stand beider live. Am Ende rechnet die App ab: der Sieger bekommt 40 Punkte und eine grüne Sieg-Einblendung, der Verlierer schuldet den Einsatz; "Eingelöst" hakt die Schuld ab. Braucht Skript 22.
